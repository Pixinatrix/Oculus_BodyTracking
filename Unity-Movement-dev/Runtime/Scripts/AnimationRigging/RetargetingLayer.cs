...
namespace Oculus.Movement.AnimationRigging
{
    ...
    public partial class RetargetingLayer : OVRUnityHumanoidSkeletonRetargeter
    {
        ...
        [System.Serializable] public class SkeletonPostProcessingEvent : UnityEngine.Events.UnityEvent<IList<OVRBone>> { } // <--- added by MichaelV    251    protected virtual void OnApplicationFocus(bool hasFocus)		
        ...
        protected override void Update()
        {
            ...
            UpdateSkeleton();
            SkeletonPostProcessing.Invoke(Bones); // <--- added by MichaelV	
